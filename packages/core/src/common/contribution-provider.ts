...
import { ContributionFilterRegistryImpl } from './contribution-filter';
...
class ContainerBasedContributionProvider<T extends object> implements ContributionProvider<T> {
    ...
    getContributions(recursive?: boolean): T[] {
        if (this.services === undefined) {
            ...
            let filterRegistry: ContributionFilterRegistryImpl | undefined;
            ...
            while (currentContainer !== null) {
                ...
                if (filterRegistry === undefined && currentContainer.isBound(ContributionFilterRegistryImpl)) {
                    filterRegistry = currentContainer.get(ContributionFilterRegistryImpl);
                }
                // eslint-disable-next-line no-null/no-null
